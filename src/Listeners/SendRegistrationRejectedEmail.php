...
final class SendRegistrationRejectedEmail implements ShouldQueue
{
    ...
    public function handle(RegistrationRejected $event): void
    {
        ...
        $this->notificationService->sendRejectionEmail($registration);
    }
}
